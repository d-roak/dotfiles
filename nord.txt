...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#282a2e', '#518aa5', '#517694', '#5f8bde', '#5f819d', '#69678f', '#5e8d87', '#707880', '#373b41', '#66abcc', '#6897bd', '#749ff0', '#81a2be', '#9694bb', '#8abeb7', '#c5c8c6']"
...
gset string palette "#282a2e:#518aa5:#517694:#5f8bde:#5f819d:#69678f:#5e8d87:#707880:#373b41:#66abcc:#6897bd:#749ff0:#81a2be:#9694bb:#8abeb7:#c5c8c6"
